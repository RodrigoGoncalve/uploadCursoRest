...
import com.algaworks.osworks.api.model.OrdemServicoImput;
...
public class OrdemServiceController {
	...
	public OrdemServicoModel criar(@Valid @RequestBody OrdemServicoImput ordemServicoImput) {
		...
		return toModel(gestaoOrdemServico.adicionar(ordemServico));
	}
	...
	public void ffinalizar(@PathVariable Long ordemServicoId) {
